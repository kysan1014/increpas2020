...
public class Questions {
	...
	/*
		1. 두 개의 숫자를 입력받은 후, 두 수를 이용하여 사각형, 삼각형의 넓이를 구하여 출력하시오.
	*/
	...
	/*
		2. 하나의 숫자(반지름)을 입력받아 원의 넓이와 둘레를 구하여 출력
	 */
...
//			System.out.printf("%d ", temp);
	...
	/*
		4. 날짜를 입력받아 해당 날짜가 몇 일, 몇 시간, 몇 분, 몇 초인지 구하여 출력
	 */
